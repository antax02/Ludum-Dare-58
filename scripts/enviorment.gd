...
func _ready() -> void:
	spawn_objects(stars, star_count, stars_parallax, false)
	spawn_objects(far_objects, far_objects_count, far_objects_parallax, true)
	spawn_objects(near_objects, near_objects_count, near_objects_parallax, true)
...
func spawn_objects(objects: Array[PackedScene], object_count: int, parallax_layer: Parallax2D, random_rotation: bool) -> void:
